...
let message;
let input = prompt("введите необходимое количество дроидов");
let totalPrice;
let creditsBalance = Number(credits - input * pricePerDroid);
...
if (input === null) {
    ...
    message = 'Вы купили ${input} дроидов, на счету осталось ${creditsBalance} кредитов.';
